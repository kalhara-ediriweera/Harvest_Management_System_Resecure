...
const PachchaStockDetail = () => {
  ...
  const getProductImage = (variety) => {
    ...
    return varietyMap[variety] || '/shopImg/pachcha.jpg';
  };
  ...
  const getVarietyDescription = () => {
    return 'A nutritious, traditional variety with low water needs and excellent taste profile. Known for its unique flavor and health benefits.';
  };

  // Determine dynamic background color based on variety
  const getBackgroundGradient = () => {
    return 'from-emerald-50 via-white to-emerald-100';
  };

  const renderStars = (rating) => {
    const stars = [];
    const fullStars = Math.floor(rating || 4.6);
    const hasHalfStar = (rating || 4.6) - fullStars >= 0.5;
          ...
          <div className="relative" ref={searchRef}>
            <div className="flex items-center bg-white rounded-full border border-gray-300 px-4 py-2 shadow-sm focus-within:ring-2 focus-within:ring-green-500 focus-within:border-green-500">
              ...
              <input
                ...
                onFocus={() => setShowSearchResults(searchTerm && searchTerm.trim() !== '')}
              />
            </div>
                  ...
                  <div className="hidden md:block">
                    ...
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-4 flex items-center">
                        {renderStars(4.6)}
                        <span className="ml-2 text-sm text-gray-600">(49 reviews)</span>
                      </div>
                    </div>
                  </div>
...
export default PachchaStockDetail;
